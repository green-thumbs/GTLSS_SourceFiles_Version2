<%-- 
    Document   : About Us.jsp
    Created on : Apr 26, 2019, 12:24:12 AM
    Author     : mtrimpin
--%>
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js"></script>
       ...
       <div id="generalinformation">
                    <div id="generalcontainer">
                        ...
                        Welcome to Green Thumb Lawn Service, your number one source for all your lawn care needs. We're dedicated to 
                        giving you the very best of lawn supplies and services, with a focus on the customer, reliability and 
                        sustainability.

                        Founded in 2019 by Jay, Kristina and Michelle, Green Thumb Lawn Service was started as a school project striving
                        to provide quality lawn care services and products through an easy to use online store. When we first started 
                        out, our passion for coding and desire to increase efficiencies and provide quality service to customers drove
                        us to create the GTLS system and gave us the impetus to turn hard work and inspiration into to an innovative
